...
class Question(models.Model):
    author      = models.ForeignKey(User, on_delete=models.CASCADE)# 계정이 삭제되면 이 계정이 작성한 질문을 모두 삭제
...
class Answer(models.Model):
    author      = models.ForeignKey(User, on_delete=models.CASCADE)# 계정이 삭제되면 이 계정이 작성한 답변을 모두 삭제
